 ...
 */
function hook_CHUNK_TYPE_chunk_type_settings_form($chunk_instance, $delta, $form, &$form_state) {
  $settings = $chunk_instance['settings'];
  $instance_settings_form = array();
  $instance_settings_form['default_text'] = array(
    '#type' => 'textarea',
...
/**
  ...
  */
function hook_CHUNK_TYPE_chunk_form_validate($configuration, &$chunk_state, $chunk_instance, $item_element, &$form_state, $form) {
